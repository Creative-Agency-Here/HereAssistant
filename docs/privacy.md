...
правок и нормализованная среда запуска (Telegram, HereAssistant CLI/VS Code,
известное приложение терминала). Произвольные заголовки окон, команды запуска и
пути не сохраняются. Этого достаточно для статистики нагрузки и лимитов, и это
не содержит текста, кода или путей файлов.
