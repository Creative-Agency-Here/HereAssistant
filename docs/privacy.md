...
Scoped-токен `has_…` привязан к конкретному CRM workspace, имеет единственное
право `sessions:write`, хранится только в окружении процесса и может быть
немедленно отозван администратором пространства.
